...
```{r}
completiondata <- read.table("data/sentence_completion_stats.txt", header = T)
## the correct verbs:
verbs<-completiondata$verb
#For each row in df, look up the verb, then choose
## the column that corresponds to that verb and save the proportion:
